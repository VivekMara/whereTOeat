...
export default function App() {
  ...
  async function response(){
    try {
      const request = await axios.get(`https://api.olamaps.io/places/v1/nearbysearch?layers=venue&types=cafe&location=${lat}%2C${lng}&radius=6000&strictbounds=false&withCentroid=false&limit=5&api_key=${import.meta.env.VITE_API_KEY}`);
